...
;; TODO update with semantic types for new additions!
...
(define-metafunction sot
  ...
  [(nop1-type inexact->exact)
   (And* (Arrow One One)
       ...
       & (Arrow Integer Integer)
       & (Arrow RealZero Zero)
       & (Arrow PosReal PosRational)
       & (Arrow NegReal NegRational)
       & (Arrow Number ExactNumber))]
  [(nop1-type exact-round)
   (And* (Arrow RealZero Zero)
         (Arrow One One)
       & (Arrow Byte Byte)
       & (Arrow Index Index)
       & (Arrow Fixnum Fixnum)
       ...
       & (Arrow NonnegReal NonnegInteger)
       & (Arrow NonposReal NonposInteger))])
...
(define-metafunction sot
  ...
  [(nop2-type expt)
   (And* (Arrow (Prod One Rational) One)
       ...
       & (Arrow (Prod (And NonnegFloat (Not FloatNegZero)) Real) (Or NonnegFloat One))
