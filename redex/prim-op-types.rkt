...
(define-metafunction sot
  ...
  [(nop1-type sqrt)
   (And* (Arrow Zero Zero)
       ...
       & (Arrow SingleFloatComplex SingleFloatComplex)
       & (Arrow Number Number))]
  [(nop1-type real->double-flonum)
   (And* (Arrow FloatPosZero FloatPosZero)
       & (Arrow FloatNegZero FloatNegZero)
       & (Arrow FloatZero FloatZero)
       & (Arrow FloatNan FloatNan)
       & (Arrow PosFloat PosFloat)
       & (Arrow NonnegFloat NonnegFloat)
       & (Arrow NegFloat NegFloat)
       & (Arrow NonposFloat NonposFloat)
       & (Arrow Float Float)
       & (Arrow SingleFloatPosZero FloatPosZero)
       & (Arrow SingleFloatNegZero FloatNegZero)
       & (Arrow RealZero FloatZero)
       & (Arrow PosInteger PosFloat)
       & (Arrow NegInteger NegFloat)
       & (Arrow NonnegReal NonnegFloat)
       & (Arrow NonposReal NonposFloat)
       & (Arrow Real Float))]
  [(nop1-type real->single-flonum)
   (And* (Arrow SingleFloatPosZero SingleFloatPosZero)
       & (Arrow SingleFloatNegZero SingleFloatNegZero)
       & (Arrow SingleFloatZero SingleFloatZero)
       & (Arrow SingleFloatNan SingleFloatNan)
       & (Arrow PosSingleFloat PosSingleFloat)
       & (Arrow NonnegSingleFloat NonnegSingleFloat)
       & (Arrow NegSingleFloat NegSingleFloat)
       & (Arrow NonposSingleFloat NonposSingleFloat)
       & (Arrow SingleFloat SingleFloat)
       & (Arrow FloatPosZero SingleFloatPosZero)
       & (Arrow FloatNegZero SingleFloatNegZero)
       & (Arrow RealZero SingleFloatZero)
       & (Arrow PosInteger PosSingleFloat)
       & (Arrow NegInteger NegSingleFloat)
       & (Arrow NonnegReal NonnegSingleFloat)
       & (Arrow NonposReal NonposSingleFloat)
       & (Arrow Real SingleFloatZero))]
  [(nop1-type inexact->exact)
   (And* (Arrow Zero Zero)
       & (Arrow One One)
       & (Arrow PosByte PosByte)
       & (Arrow Byte Byte)
       & (Arrow PosIndex PosIndex)
       & (Arrow Index Index)
       & (Arrow PosFixnum PosFixnum)
       & (Arrow NonnegFixnum NonnegFixnum)
       & (Arrow NegFixnum NegFixnum)
       & (Arrow NonposFixnum NonposFixnum)
       & (Arrow Fixnum Fixnum)
       & (Arrow PosInteger PosInteger)
       & (Arrow NonnegInteger NonnegInteger)
       & (Arrow NegInteger NegInteger)
       & (Arrow NonposInteger NonposInteger)
       & (Arrow Integer Integer)
       & (Arrow PosExactRational PosExactRational)
       & (Arrow NonnegExactRational NonnegExactRational)
       & (Arrow NegExactRational NegExactRational)
       & (Arrow NonposExactRational NonposExactRational)
       & (Arrow ExactRational ExactRational)
       & (Arrow RealZero Zero)
       & (Arrow PosReal PosExactRational)
       & (Arrow NonnegReal NonnegExactRational)
       & (Arrow NegReal NegExactRational)
       & (Arrow NonposReal NonposExactRational)
       & (Arrow Real ExactRational)
       & (Arrow Number ExactNumber))])
