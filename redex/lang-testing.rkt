...
(module+ test
  ...
  (type-check-tests
   ...
   [-1/2 NegRationalNotInteger]
   [+nan.0 FloatNaN]
   [+0.0 FloatPosZero]
   [-0.0 FloatNegZero]
   [1.0 PosFloatNumber]
   [+inf.0 PosFloatInfinity]
   [-1.0 NegFloatNumber]
   [-inf.0 NegFloatInfinity]
   [+nan.f SingleFloatNaN]
   [+0.0f0 SingleFloatPosZero]
   [-0.0f0 SingleFloatNegZero]
   [1.0f0 PosSingleFloatNumber]
   [+inf.f PosSingleFloatInfinity]
   [-1.0f0 NegSingleFloatNumber]
   [-inf.f NegSingleFloatInfinity]
   [0+123i ExactImaginary]
   [123+456i ExactComplex]
   [0+123.456i FloatImaginary]
   [0+456.789f0i SingleFloatImaginary]
   [789+123.456i FloatComplex]
   [981.0f0+456.789f0i SingleFloatComplex]
   ["42" String]
   [#true True]
   [#false False]
