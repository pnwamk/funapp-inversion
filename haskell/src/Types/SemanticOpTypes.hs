...
opTypes =
  ...
  , ("=", (BinOp
            ...
            , (And[exactNumber, (Not byte)], byte, F)
            , (byte, And[exactNumber, (Not byte)], F)
            , (And[exactNumber, (Not index)], index, F)
            , (index, And[exactNumber, (Not index)], F)
            , (And[exactNumber, (Not fixnum)], fixnum, F)
            , (fixnum, And[exactNumber, (Not fixnum)], F)
            , (And[exactNumber, (Not integer)], integer, F)
            , (integer, And[exactNumber, (Not integer)], F)
            , (And[exactNumber, (Not rational)], rational, F)
            , (rational, And[exactNumber, (Not rational)], F)
