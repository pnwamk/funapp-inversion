...
opTypes =
  ...
  , ("=", (CompOp
            [ (real, realZero, (IsA ArgZero realZeroNoNaN), (IsA ArgZero (tyNot mtEnv realZeroNoNaN)))
            , (realZero, real, (IsA ArgOne realZeroNoNaN), (IsA ArgOne (tyNot mtEnv realZeroNoNaN)))
            , (exactNumber, one, (IsA ArgZero one), (IsA ArgZero (tyNot mtEnv one)))
            , (one, exactNumber, (IsA ArgOne one), (IsA ArgOne (tyNot mtEnv one)))
