...
opTypes =
  ...
  , ("abs", (UnOp
             ...
             , (realZero, realZero)
             , ((tyOr' mtEnv [positiveInteger, negativeInteger]), positiveInteger) -- abs not be closed on fixnums
             , (integer, nonnegativeInteger)
             , ((tyOr' mtEnv [positiveRational, negativeRational]), positiveRational)
             , (rational, nonnegativeRational)
             , ((tyOr' mtEnv [positiveFloat, negativeFloat]), positiveFloat)
             , (float, nonnegativeFloat)
             , ((tyOr' mtEnv [positiveSingleFloat, negativeSingleFloat]), positiveSingleFloat)
             , (singleFloat, nonnegativeSingleFloat)
             , ((tyOr' mtEnv [positiveInexactReal, negativeInexactReal]), positiveInexactReal)
  ...
  , ("+", (BinOp
            ...
            , (real, float, float)
            , (float, float, float)
            , (positiveSingleFloat, (tyOr' mtEnv [nonnegativeRational, nonnegativeSingleFloat]), positiveSingleFloat)
            , ((tyOr' mtEnv [nonnegativeRational, nonnegativeSingleFloat]), positiveSingleFloat, positiveSingleFloat)
            , ((tyOr' mtEnv [positiveRational, positiveSingleFloat]), nonnegativeSingleFloat, positiveSingleFloat)
            , (nonnegativeSingleFloat, (tyOr' mtEnv [positiveRational, positiveSingleFloat]), positiveSingleFloat)
            , (negativeSingleFloat, (tyOr' mtEnv [nonpositiveRational, nonpositiveSingleFloat]), negativeSingleFloat)
            , ((tyOr' mtEnv [nonpositiveRational, nonpositiveSingleFloat]), negativeSingleFloat, negativeSingleFloat)
            , ((tyOr' mtEnv [negativeRational, negativeSingleFloat]), nonpositiveSingleFloat, negativeSingleFloat)
            , (nonpositiveSingleFloat, (tyOr' mtEnv [negativeRational, negativeSingleFloat]), negativeSingleFloat)
            , (nonnegativeSingleFloat, (tyOr' mtEnv [nonnegativeRational, nonnegativeSingleFloat]), nonnegativeSingleFloat)
            , ((tyOr' mtEnv [nonnegativeRational, nonnegativeSingleFloat]), nonnegativeSingleFloat, nonnegativeSingleFloat)
            , (nonpositiveSingleFloat, (tyOr' mtEnv [nonpositiveRational, nonpositiveSingleFloat]), nonpositiveSingleFloat)
            , ((tyOr' mtEnv [nonpositiveRational, nonpositiveSingleFloat]), nonpositiveSingleFloat, nonpositiveSingleFloat)
            ...
            , (inexactComplex, (tyOr' mtEnv [rational, inexactReal, inexactComplex]), inexactComplex)
            , ((tyOr' mtEnv [rational, inexactReal, inexactComplex]), inexactComplex, inexactComplex)
  ...
  , ("-", (BinOp
            ...
            , (inexactReal, (tyOr' mtEnv [inexactReal, rational]), inexactReal)
            , ((tyOr' mtEnv [inexactReal, rational]), inexactReal, inexactReal)
            , (real, real, real)
            , (exactNumber, exactNumber, exactNumber)
            ...
            , (inexactComplex, (tyOr' mtEnv [inexactComplex, exactNumber]), inexactComplex)
            , ((tyOr' mtEnv [inexactComplex, exactNumber]), inexactComplex, inexactComplex)
            , (number, number, number)]))
  ...
  , ("*", (BinOp
            ...
            , (nonnegativeSingleFloat, (tyOr' mtEnv [positiveRational, nonnegativeSingleFloat]), nonnegativeSingleFloat)
            , ((tyOr' mtEnv [positiveRational, nonnegativeSingleFloat]), nonnegativeSingleFloat, nonnegativeSingleFloat)
            ...
            , (nonnegativeInexactReal, (tyOr' mtEnv [positiveRational, nonnegativeInexactReal]), nonnegativeInexactReal)
            , ((tyOr' mtEnv [positiveRational, nonnegativeInexactReal]), nonnegativeInexactReal, nonnegativeInexactReal)
            , (inexactReal, (tyOr' mtEnv [positiveRational, negativeRational, inexactReal]), inexactReal)
            , ((tyOr' mtEnv [positiveRational, negativeRational, inexactReal]), inexactReal, inexactReal)
            , (inexactReal, inexactReal, inexactReal)
  ...
  , ("/", (BinOp
            ...
            , (float, float, float)
            , (negativeSingleFloat, negativeSingleFloat, nonnegativeSingleFloat) -- possible underflow, so no neg neg -> pos
            , (positiveSingleFloat, (tyOr' mtEnv [positiveRational, positiveSingleFloat]), nonnegativeSingleFloat)
            , ((tyOr' mtEnv [positiveRational, positiveSingleFloat]), positiveSingleFloat, nonnegativeSingleFloat)
            , (singleFloat, (tyOr' mtEnv [positiveRational, negativeRational, singleFloat]), singleFloat)
            , ((tyOr' mtEnv [positiveRational, negativeRational, singleFloat]), singleFloat, singleFloat)
            , (singleFloat, singleFloat, singleFloat)
            , (negativeInexactReal, negativeInexactReal, nonnegativeInexactReal)
            , (positiveInexactReal, (tyOr' mtEnv [positiveRational, positiveInexactReal]), nonnegativeInexactReal)
            , ((tyOr' mtEnv [positiveRational, positiveInexactReal]), positiveInexactReal, nonnegativeInexactReal)
            , (inexactReal, (tyOr' mtEnv [positiveRational, negativeRational, inexactReal]), inexactReal)
            , ((tyOr' mtEnv [positiveRational, negativeRational, inexactReal]), inexactReal, inexactReal)
            , (inexactReal, inexactReal, inexactReal)
  ...
  , ("<", (CompOp
           ...
           , (real, positiveInfinity, (IsA ArgZero (tyNot mtEnv (tyOr' mtEnv [inexactRealNaN, positiveInfinity]))), (IsA ArgZero (tyOr' mtEnv [inexactRealNaN, positiveInfinity])))
           , (negativeInfinity, real, (IsA ArgOne (tyNot mtEnv (tyOr' mtEnv [inexactRealNaN, negativeInfinity]))), (IsA ArgOne (tyOr' mtEnv [inexactRealNaN, negativeInfinity])))
  ...
  , ("<=", (CompOp
             [ (integer, one, (IsA ArgZero (tyOr' mtEnv [nonpositiveInteger, one])), (IsA ArgZero positiveInteger))
             ...
             , (real, positiveInfinity, (IsA ArgZero (tyNot mtEnv inexactRealNaN)), (IsA ArgZero inexactRealNaN))
             , (negativeInfinity, real, (IsA ArgOne (tyNot mtEnv inexactRealNaN)), (IsA ArgOne inexactRealNaN))
             , (positiveInfinity, real, (IsA ArgOne positiveInfinity), (IsA ArgOne (tyNot mtEnv positiveInfinity)))
             , (real, negativeInfinity, (IsA ArgZero negativeInfinity), (IsA ArgZero (tyNot mtEnv negativeInfinity)))
  ...
  , ("=", (CompOp
            [ (real, realZeroNoNaN, (IsA ArgZero realZeroNoNaN), (IsA ArgZero (tyNot mtEnv realZeroNoNaN)))
            , (realZeroNoNaN, real, (IsA ArgOne realZeroNoNaN), (IsA ArgOne (tyNot mtEnv realZeroNoNaN)))
